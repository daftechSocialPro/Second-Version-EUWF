...
namespace DAFwebAPI.Controllers
{
    ...
    public class TrainingController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post([FromForm] TrainingPostDto research, string jwt)
        {
        ...
        [HttpPut]
        public async Task<ActionResult> Update([FromForm] TrainingPostDto research, string jwt)
        {
