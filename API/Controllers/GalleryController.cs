...
namespace DAFwebAPI.Controllers
{
    ...
    public class GalleryController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post([FromForm] GalleryPostDto research, string jwt)
        {
        ...
        [HttpPut]
        public async Task<ActionResult> Update([FromForm] GalleryPostDto research, string jwt)
        {
